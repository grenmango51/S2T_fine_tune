...
from s2t.common import BASE_MODEL, PROJECT_ROOT, SAMPLE_RATE, load_audio_16k, normalize_text
...
def merge_lora_and_save(
    ...
    if speaker:
        candidate_wavs = list((PROJECT_ROOT / "data").glob(f"**/{speaker.upper()}/arctic_a0001.wav"))
    else:
...
def main():
    ...
    parser.add_argument(
        ...
        type=str.upper,
        default=None,
        help="Prefer this speaker's audio for the merged-model smoke test",
    )
